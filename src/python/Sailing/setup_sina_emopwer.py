...
os.path.isdir('tmp') or os.mkdir('tmp')
import shutil
shutil.copy("sina_empower/webrobot_settings.py", 'tmp')
shutil.copy("sina_empower/libs/actions.py", 'tmp')
# Dynamically calculate the version based on django.VERSION.
version = "1 0 0"

setup(
    name = "emop_webrobot_sina_weibo",
    version = version.replace(' ', '-'),
    url = 'http://www.zaol.cn',
    download_url="xx",
    author = 'wudalong',
    ...
    package_dir={'':'tmp',  'sailing': 'src/sailing', 'selenium': 'libs/selenium', 'simplejson': 'libs/simplejson'},
)
